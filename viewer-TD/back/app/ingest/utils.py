...
def to_int(value: Any, default: int | None = None) -> int | None:
    """Safely coerce TopPIC-exported string/number to int; return ``default`` if parsing fails."""
...
def to_float(value: Any, default: float | None = None) -> float | None:
    """Safely coerce string/number to float; return ``default`` if parsing fails."""
    if value is None or value == "":
        return default
    try:
        return float(value)
