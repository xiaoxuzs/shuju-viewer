...
".venv\Scripts\python.exe" -m uvicorn app.main:app --reload --port 7000 2>&1 | "%SystemRoot%\System32\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -Command "$input | Tee-Object -FilePath '%LOG_FILE%'"
endlocal
