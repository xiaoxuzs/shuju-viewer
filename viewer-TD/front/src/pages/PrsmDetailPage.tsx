/**
 * PrSM detail: loads PrSM JSON, MS1/MS2 spectra and parsed views — sequence chart, fragmentation,
 * matched-peak grid, fullscreen spectrum modal; inline notes cover zoom behavior and data flow.
 */
