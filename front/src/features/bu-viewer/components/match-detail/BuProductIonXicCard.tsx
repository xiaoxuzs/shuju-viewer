...
import { fetchBuMatchProductXics } from "@/features/bu-viewer/api/buClient";
import { BuProductIonXicChart } from "@/features/bu-viewer/components/spectrum/BuProductIonXicChart";
import type { BuMatchedIon } from "@/features/bu-viewer/types";
import {
  MAX_PRODUCT_ION_XICS,
  productIonLabel,
  type ProductIonSelection,
} from "@/features/bu-viewer/components/match-detail/productIonSelection";
import { assignProductIonColors } from "@/features/bu-viewer/components/match-detail/productIonColors";
import {
...
} from "@/features/bu-viewer/components/match-detail/productIonBatch";
